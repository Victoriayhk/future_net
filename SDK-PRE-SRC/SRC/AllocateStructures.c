...
void AllocateStructures()
{
    ...
    SRandom(Seed);
    assert(Rand = (unsigned *)malloc((Dimension + 1) * sizeof(unsigned)));
    ...
    assert(SwapStack = (SwapRecord *) malloc((MaxSwaps + 6 * K) * sizeof(SwapRecord)));
}
